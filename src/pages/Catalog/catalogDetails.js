                        ...
                        <>
                            ...
                            <div className="p-3 sm:hidden ">
                                <button
                                    onClick={sendResponse}
                                    type="submit"
                                    className="mb-4 fixed bottom-0 right-2 left-2  md:w-1/2 w-90 p-3 rounded-full text-white bg-gradient-to-l from-[#020065] to-[#0400CB] flex items-center justify-center"
                                >
                                    {isLoading ? (
                                        <svg
                                            aria-hidden="true"
