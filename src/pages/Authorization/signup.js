                                            ...
                                            <div className="relative w-full h-auto group rounded-full">
                                                ...
                                                <div className="absolute inset-0 bg-black bg-opacity-10 rounded-full flex justify-end items-start group-hover:bg-opacity-20 transition duration-300">
                                                    ...
                                                    <IconButton
                                                        aria-label="delete"
                                                        size="small"
                                                        className="absolute top-0 right-0 bg-white text-red-500 p-2 rounded-full group-hover:bg-red-500 group-hover:text-white shadow-md transition duration-300"
