                        ...
                        <ul class="space-y-2 font-medium p-3">
                            <li className="mt-2">
                                {currentUrl === "/dashboard" ? (
                                    ...
                                    <Link to="/dashboard" class=" text-start flex  items-start p-2 text-white p-4  dark:text-white bg-gradient-to-l from-[#020065] to-[#0400CB]  group">
                                    ...
                                    <Link to="/dashboard" class="text-start flex  items-start p-2 text-gray-900 p-4 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <li >
                                ...
                                {currentUrl === "/catalogs" ? (
                                    <Link to="/catalogs" class="my-5 text-start flex  items-start p-2 text-white p-4 dark:text-white bg-gradient-to-l from-[#020065] to-[#0400CB] group">
                                        <svg
                                    ...
                                    <Link to="/catalogs" class="my-5 hover:text-black text-start flex items-center p-4 text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <svg
                            ...
                            <li>
                                {currentUrl === "/payouts" ? (
                                    <Link
                                        to="/payouts"
                                        class="text-start flex items-start p-4 text-white  dark:text-white bg-gradient-to-l from-[#020065] to-[#0400CB] group"
                                    >
                                        <svg
                                            class="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-gray-400"
                                            aria-hidden="true"
                                    ...
                                    <Link
                                        to="/payouts"
                                        class="hover:text-black text-start flex items-center p-4 text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                    >
                                        <svg
                            ...
                            <li>
                                {currentUrl === "/notifications" ? (
                                    <Link
                                        to="/notifications"
                                        class="text-start my-5 flex items-start p-4 text-white  dark:text-white bg-gradient-to-l from-[#020065] to-[#0400CB] group"
                                    >
                                        <svg
                                            class="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-gray-400"
                                            aria-hidden="true"
                                    ...
                                    <Link
                                        to="/notifications"
                                        class="hover:text-black my-5 text-start flex items-center p-4 text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                    >
                                        <svg
                                            class="text-start flex-shrink-0 w-6 h-6 text-gray-900 dark:text-white"
                                            aria-hidden="true"
