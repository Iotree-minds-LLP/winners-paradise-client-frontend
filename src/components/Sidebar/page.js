...
const Sidebar = () => {
    ...
    return (
        <>
            <div>
                <aside id="border border-1 border-gray-50 separator-sidebar" class="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 " >
                    <li style={{ listStyle: 'none' }} className="bg-gradient-to-l from-[#020065] to-[#0400CB]">
                        <img
                            className="h-auto w-full p-3 md:mt-0 sm:mt-20 mt-10 text-start z-10"
                            src={imageLogo}
                        />
                    </li>
